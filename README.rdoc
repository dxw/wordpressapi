...
We magick[http://github.com/dxw/wordpressapi] to convert WordPress's documentation to RDoc and format the output using wpdoc[http://github.com/dxw/sdoc/tree/wordpress], our fork of the beautiful sdoc[http://github.com/voloko/sdoc].
